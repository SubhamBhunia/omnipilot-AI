...
export class PestDiseaseAgent {
  private name = "PestDiseaseAgent";
  private systemPrompt = `You are a Plant Pathologist and Entomologist.
...
clearly state the substance name and the exact dosage.`;
  ...
  public diagnose(input: PestDiagnosisInput): DiseaseRecommendation {
