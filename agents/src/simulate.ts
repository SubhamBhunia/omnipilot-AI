...
// Localized Mock Database for self-contained simulation
...
function simulateMcpValidateTool(zoneId: string, substance: string, dosage: number) {
...
async function runSimulation() {
  ...
  const result3 = await orchestrator.runWorkflow(
    query3,
    "Zone-A",
    telemetry3,
    simulateMcpValidateTool
