...
interface SafetyPolicy {
  ...
  maxDosageGPerSqm: Record<string, number>;
  waterBodyBufferZoneMeters: Record<string, number>;
  cropRestrictions: Record<string, string[]>;
}
 ...
 */
export function sanitizeAndValidateString(input: string, fieldName: string): string {
 ...
 */
export function evaluateChemicalSafety(
  zoneId: string,
  substance: string,
  dosage: number
